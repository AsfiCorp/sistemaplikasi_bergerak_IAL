  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      body: ListView(
        ...
        children: [
          Text('Global Settings', style: GoogleFonts.epilogue(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
          ...
          Text('Content', style: GoogleFonts.epilogue(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
          const SizedBox(height: 16),
          SwitchListTile(
